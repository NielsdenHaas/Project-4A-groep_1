...
function waardeAanpassen() {
    ...
    document.getElementById("wissen").innerHTML = omrekenenTalstelsels(omrekenen, van, naar);
}

function waardeAanpassenFactorizer() {
    var invoer = document.getElementById("omreken-talstelsel").value;

    document.getElementById("wissen").innerHTML = factoriser(invoer);
}
